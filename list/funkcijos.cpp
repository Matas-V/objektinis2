...
void read_file(list <studentas>& sar, string file, string med, int index) {
  studentas st;
  ...
  try {
    ...
    cout << "Failo nuskaitymas ir sudejimas i lista uztruko: " << diff.count() << endl;

    sar.sort([](studentas a, studentas b){
...
void isvedimas(list<studentas> &temp, int n, string med) {
...
void failoIsvedimas(list<studentas> &temp, string med, string fileKiet, string fileVarg) {
  string outkiet="", outvarg="";
  list<studentas> kiet, varg;
